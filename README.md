...
v0.21 增加 R2 共享构建缓存、锁文件键、分支隔离和代号清理，见 [CI 缓存](docs/CI-CACHES-v21.md)。
...
**自己的代码，自己的空间。** 基于 Cloudflare Workers 的开源 Git 服务，部署于 **[git.1s.hk](https://git.1s.hk)**。AGPL-3.0-only，**v0.21.0 alpha**。
